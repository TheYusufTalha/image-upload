...
$name = $name.".".$ext;
$resim_urli = $base_url.'en/img/'.$name;
...
}else{ '<script> alert("Please check your folder permissions."); window.location = "/tr/anasayfa";</script>';}
}else{
echo '<script> alert("Please add an image file or fill in the link blank."); window.location = "/tr/anasayfa";</script>';
}
