		...
		if ($_POST) {
			if ($_FILES["resim"]["size"]<1024*1024*1024*1024){
				if ($_FILES["resim"]["type"]=="image/png" or $_FILES["resim"]["type"]=="image/jpeg" or $_FILES["resim"]["type"]=="image/gif" ) {
					...
					echo '<script> alert("Lütfen bir dosya ekleyin."); window.location = "/tr/anasayfa";</script>';
				}
			}else{
				echo '<script> alert("Bu dosya sitemizin kabul ettiğinden çok daha büyük."); window.location = "/tr/anasayfa";</script>';
			}
		}else {
